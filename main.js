...
function my_keydown(e)
{
	...
	function down()
	{
		...
		{
		ball_y = ball_y + block_image_height;
console.log("alto de la imagendel bloque=" + block_image_width);
console.log("Cunado se precione la tecla derecha,x =" + ball_x+ ", y=" + ball_y);
canvas.remove(ball_obj);
new_image();
		}
	...
	function right()
	{
		if(ball_x <=1050)
		{
			ball_x = ball_x - block_image_width;
			console.log("ancho de la imagen del bloque = " + block_image_width);
			console.log("Cuando se presione la tecla derecgha, X =  " + ball_x + " , Y = "+ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
